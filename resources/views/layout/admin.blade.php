...
<head>
    ...
    <link rel="stylesheet" href="{{ url('') }}/dist/css/alt/adminlte.light.css">

    <link rel="stylesheet" href="{{ url('') }}/dist/css/alt/adminlte.pages.css">
    <!-- overlayScrollbars -->
                    ...
                    <div class="navbar-search-block">
                        <form class="form-inline">
                            <div class="input-group input-group-sm">
                                <input class="form-control form-control-navbar" name="keyword" type="text"
